...
| [Spotify](documentation/spotify.md)                      | spotify.vg.route1337.com             | 192.168.33.51 | VirtualBox         | A Windows 7 box with GUI that contains Spotify                                                        | A Windows box specifically to keep Spotify from injecting tracking pixels into my HTTP streams      |
